...
def weather_api():
    ...
    if lastWeatherUpdate + 300 <= time.time():
        request = requests.get(f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/1328%20Trion%20Hwy%2C%20Lafayette%2C%20GA%2C%20USA?unitGroup=us&key={api_token}&contentType=json")
